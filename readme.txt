Rep consists of 2 files - file with dictionaries and lists of possible particles of names and addreses and file with functions, gathering and randomising data from the first file.
...
You also can import random_clients_generator.py and use it's main function along with i.e. a SQL client to generate a client data base.
